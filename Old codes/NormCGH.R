NormCGH <- function(cgh, is.Agilent = TRUE, Cy = TRUE, GC = TRUE, Centr = TRUE, span = 0.3, cut = c(0.05, 0.95), G = 3:7, peakThresh = 0.5, method = "Zero", Plot = TRUE, Save = TRUE){
