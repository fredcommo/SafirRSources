...
loadPreAgilent <- function(FileName, Safir.Id, hg19.info){
...
agil.hg19 <- try(read.table("D:/Projet Safir/Data SAFIR/Arrays Infos/022060_4x180K_hg19_20110628_GenomePos&GC_FC.txt", header = T, sep = "\t"), silent = T)
{
