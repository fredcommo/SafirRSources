NormCGH.v6.1 <- function(cgh, is.Agilent = TRUE, Cy = TRUE, GC = TRUE, Centr = TRUE, Fract = 1, span = 0.3, cut = c(-0.5, 0.5), G = 3:7, peakThresh = 0.75, MergePeaks = T, MergeVal = 0.075, method = "Left", Plot = TRUE, Expand = 1.75, Save = TRUE, Root = "E"){
