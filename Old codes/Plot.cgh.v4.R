...
Plot.cgh.v4 <- function(Scgh, greq, hg19.info, cutGainLoss = 10, cutAmpDel = 85,
...
data <- Scgh$cgh
	...
	# Graphique principal
		...
		points(pos[-which(chr == 24)], Rmed[-which(chr == 24)], pch = ".", col = "black", cex = 1)												# visualisation de la segmentation
