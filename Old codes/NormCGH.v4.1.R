NormCGH.v4.1 <- function(cgh, is.Agilent = TRUE, Cy = TRUE, GC = TRUE, Centr = TRUE, span = 0.3, Fract.adjust = TRUE, Fract = 1, cut = c(0.001, 0.999), G = 3:7, MergePeaks = TRUE, peakThresh = 0.85, MergeVal = 0.075,  method = "Left", Expand = 1.75, Save = TRUE, Root = "E"){
