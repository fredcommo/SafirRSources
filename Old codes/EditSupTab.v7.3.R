...
EditSupTab.v7.3 <- function(stab = seg.table, CGH = Scgh, use.medians = TRUE, Select = c("Gain", "Loss", "Both"), Thresh.Gain = 1, Thresh.Loss = -1, CHR = 1:23, Restrict = FALSE, Root = "E"){
...
################################################################
	...
	switch(Select,  Gain = (selecType = "gained"),
					Loss = (selecType = "lost"),
					Both = (selecType = "gained or lost")
					)
	# Define File name and table title
