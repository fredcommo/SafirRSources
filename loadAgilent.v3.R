...
loadAgilent.v3 <- function(Root = Root){
...
cat("Step1: I'm getting mArray information...")
...
{
if(class(a.info)!="try-error") cat("\nCGH data have been correctly loaded:", "\n\tFolder: ", getwd(), "\n\tFileName:", FileName, "\n\tSafir.Id:", Safir.Id, "\n")
...
cat("\nCGH data have been correctly loaded\n")
		...
		# Step3: Load Agilent annotation table(+ hg19 genomic position + CG% information)
cat("\nStep3: I'm loading supplementary annotation tables...")
agil.hg19 <- try(read.table('/Users/fredcommo/Documents/Projet Safir/Arrays Infos/022060_4x180K_hg19_20110628_GenomePos&GC_FC.txt', header = T, sep = "\t"), silent = T)
{
...
cat("\nStep5: Suppressing duplicated probes...\n")
...
cat("\nStep6: hg19 genomic positioning of probes...\n")
